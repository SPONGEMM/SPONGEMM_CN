...
compatibility. See
[Collective Variables Guide](/文档/SPONGE2.0/input-reference/collective-variables/)
for the supported CV types, virtual atoms, printing, and complete examples.
...
Detailed SinkMeta parameter list:
[sinkmeta.md](/文档/SPONGE2.0/input-reference/sinkmeta/)
